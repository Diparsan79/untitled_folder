...
<head>
    ...
    <title>Admin - Email Preview | Shiksha Mitra</title>
...
<body>
    <div class="container">
        <div class="header">
            <div class="brand">Shiksha Mitra — Admin Email Preview</div>
            <div class="toggle">
                <span>Dark mode</span>
    ...
    <script>
        ...
        (function() {
            ...
            switchEl.addEventListener('click', function() {
                ...
                try { localStorage.setItem('shiksha_theme', nowDark); } catch (e) {}
            });
        })();
    </script>
</body>
