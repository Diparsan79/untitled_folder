<?php
/**
 * Setup Script for Shiksha Mitra Verification System
...
<html>
<head>
    <title>Setup Shiksha Mitra Verification System</title>
        ...
        <div class='col-md-8'>
            <div class='card'>
                <div class='card-header bg-primary text-white'>
                    <h3 class='mb-0'>🔧 Shiksha Mitra Setup</h3>
                </div>
                <div class='card-body'>";
...
try {
    ...
    echo "<p><strong>Your Shiksha Mitra verification system is now ready!</strong></p>";
    ...
    echo "<a href='admin/index.php' class='btn btn-primary btn-lg'>";
