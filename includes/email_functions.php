...
function renderSpecialIDEmailHtml($full_name, $special_id, $community_name) {
    ...
    <div class='header'><h1>🎓 Shiksha Mitra</h1><h2>Welcome to Our Educational Community!</h2></div>
    <div class='content'>
      <h3>Dear " . htmlspecialchars($full_name) . ",</h3>
      <p><strong>🎉 Congratulations! Your application has been approved.</strong></p>
      <p>You are now a verified member of Shiksha Mitra representing <strong>" . htmlspecialchars($community_name) . "</strong>.</p>
      ...
      <h4>How to Login:</h4>
      <ol>
        <li>Go to: <a href='https://your-domain/auth/login.php'>Shiksha Mitra Login</a></li>
      ...
      <p><strong>Thank you for joining our mission to improve education!</strong></p>
      <hr><p><small>If you have any questions, reply to this email.</small></p>
    </div>
    <div class='footer'>&copy; 2024 Shiksha Mitra - Educational Community Platform</div>
    </body></html>";
}
...
function renderRejectionEmailHtml($full_name, $reason = '') {
    ...
    <div class='header'><h1>📧 Shiksha Mitra</h1><h2>Application Status Update</h2></div>
    <div class='content'>
      <h3>Dear " . htmlspecialchars($full_name) . ",</h3>
...
function renderApplicationConfirmationEmailHtml($full_name) {
    ...
    <div class='header'><h1>📋 Shiksha Mitra</h1><h2>Application Confirmation</h2></div>
    <div class='content'>
      <h3>Dear " . htmlspecialchars($full_name) . ",</h3>
...
function sendSpecialIDEmail($email, $full_name, $special_id, $community_name) {
    $subject = "Shiksha Mitra - Your Application Approved";
...
function sendRejectionEmail($email, $full_name, $reason = '') {
    $subject = "Shiksha Mitra - Application Update";
...
function sendApplicationConfirmationEmail($email, $full_name) {
    $subject = "Application Received - Shiksha Mitra";
